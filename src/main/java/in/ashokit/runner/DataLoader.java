...
public class DataLoader implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		repo.deleteAll();// first it will delete existing records from table then it will insert new
							// record in table
		// if don't write 'repo.deleteAll();' then if 10 tyms project runs then 10 tyms records will
		                   // be inserted, duplicate records will be inserted
		...
		List<CitizenPlan> list = Arrays.asList(c1, c2, c3, c4, c5, c6, c6, c7, c8, c9, c10, c11, c12);
		repo.saveAll(list);
